...
namespace Libraria {
	namespace Reflection {
		public static partial class RuntimeExtensions {
			public static object GetFieldValue(this object O, string FieldName, BindingFlags BF = ReflectionRuntime.DefaultFlags) {
			...
			public static void SetFieldValue(this object O, string FieldName, object Val, BindingFlags BF = ReflectionRuntime.DefaultFlags) {
				FieldInfo FInfo = O.GetFieldInfo(FieldName, BF);
				if (FInfo == null)
			...
			public static object SetFieldValue(this object O, object AnonType, BindingFlags BF = ReflectionRuntime.DefaultFlags) {
